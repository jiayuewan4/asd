...
ytrain = np.loadtxt(open("train.csv",'rb'),delimiter=',',skiprows=1,usecols=0,max_rows=40000)
xtrain = np.loadtxt(open('train.csv','rb'),delimiter=',',skiprows=1,usecols=range(784),max_rows=40000)
ytest = np.loadtxt(open('train.csv','rb'),delimiter=',',skiprows=40001,usecols=0)
xtest = np.loadtxt(open('train.csv','rb'),delimiter=',',skiprows=40001,usecols=range(784))
